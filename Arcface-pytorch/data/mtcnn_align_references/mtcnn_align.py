...
def align_img(i_face,coord5point,ratio,path,height,width):    
    box = i_face["box"]
...
def get_align_img(img,coord5point,ratio,path):
    ...
    if(len(face)>1):
        ...
        face = face[tar]
        align_img(face,coord5point,ratio,path,height,width)   
    elif(len(face)==1):
        face = face[0]    
        align_img(face,coord5point,ratio,path,height,width)   
    else:
...
if __name__ == '__main__':
    ...
    '''
    pic_path = 'D:\\lab\\arcface-pytorch-master\\data\\64_CASIA-FaceV5_origin'#origin
    root = 'D:\\lab\\arcface-pytorch-master\\data\\64_CASIA-FaceV5'     # target
    ...
    '''
    #save_test
    img = cv2.imread("D:\\lab\\arcface-pytorch-master\\data\\64_CASIA-FaceV5_origin\\482\\482_4.bmp")
    path = 'C:\\Users\\TBT\\Desktop\\000_1.bmp'
